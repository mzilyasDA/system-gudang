...
// Memasukkan file autoload.inc.php dari library Dompdf
require_once(dirname(__DIR__) . '/libraries/dompdf/autoload.inc.php');

// Menggunakan namespace Dompdf dan Dompdf\Options
use Dompdf\Dompdf;
use Dompdf\Options;
...
class Barang extends CI_Controller
{
	...
	public function __construct()
	{
		...
		// Memeriksa peran pengguna, hanya petugas dan admin yang diizinkan
		if ($this->session->login['role'] != 'petugas' && $this->session->login['role'] != 'admin') redirect();

		// Inisialisasi data dan memuat model M_barang
		$this->data['aktif'] = 'barang';
		$this->load->model('M_barang', 'm_barang');
	}
	// Menampilkan halaman utama dengan data barang
	...
	public function tambah() //camelcase
	{
	...
	public function proses_tambah() //snake_case
	{
		...
		// Menambahkan data menggunakan model M_barang
	...
	// Menampilkan halaman ubah barang
